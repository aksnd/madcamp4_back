...
from .views import ItemViewSet, simple_text, PredictView,CheckPrice, chatbot_response, EmotionView, recommend_company;
...
urlpatterns = [
    ...
    path('api/recommend', recommend_company, name='recommend')
]